  ...
  <el-row class="warp" style="padding:20px 0 0 20px;">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>提现审批</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
...
<!--     <el-col :span="24" class="warp-main">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="form">
         <el-form-item>
          <el-input v-model="form.name" size="small" placeholder="请输入商家名称" style="min-width: 200px;" ></el-input>
        </el-form-item>
    ...
    <el-table :data="list" border stripe size="small" style="width: 95%;">
      ...
      <el-table-column prop="created_at" label="申请时间" min-width="100" align="center">
      </el-table-column>
      <el-table-column prop="store.name" label="商家名称" min-width="200" align="center">
      </el-table-column>
      ...
      <el-table-column label="操作" min-width="200" align="center" v-show="checkper1">
       <template slot-scope="scope">
        <el-tag size="mini" type="success" v-show="scope.row.state==1 ? true : false">已发放</el-tag>
        <el-tag size="mini" type="danger" v-show="scope.row.state==2 ? true : false">已拒绝</el-tag>
        <el-button type="primary" v-show="scope.row.state==0 ? true : false" size="mini" @click="handleEdit(scope.row)">发放</el-button>
...
<script>
  ...
  import { shoptxCheck } from '../../api/api';
  ...
  export default {
    ...
    methods:{
      checkPer(){
        ...
        if(per.indexOf('StoreWithdrawcheck')>-1){
          this.checkper1=true;
        }
      },
      ...
      handleEdit(row){
        ...
        shoptxCheck(allParams).then((res) => {
          console.log(res)
          Message({
            message: "审核成功",
            type: 'success'
